...
default['backup_manager']['cron_minute'] = '0'
default['backup_manager']['cron_hour'] = '0'
default['backup_manager']['cron_day'] = '*'
default['backup_manager']['cron_month'] = '*'
default['backup_manager']['cron_weekday'] = '*'
